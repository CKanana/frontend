      ...
      <div className="auth-right">
        <div className="auth-right-content">
          ...
          {isLogin ? (
            ...
            <>
              <h2 className="signup h2" style={{ color: '#fff' }}>Create Account</h2>
              <div className="auth-subtitle">Join us today</div>
              ...
              <form className="auth-form" onSubmit={handleSubmit}>
                <div className="input-icon-wrapper">
                  ...
                  <input type="text" placeholder="Username" className="auth-input" style={{ paddingLeft: '2.2rem' }} />
                </div>
                <div className="input-icon-wrapper">
                  <span className="input-icon" aria-hidden="true">
                    {/* Email icon */}
                  ...
                  <input type="email" placeholder="Email" className="auth-input" style={{ paddingLeft: '2.2rem' }} />
                </div>
                <div className="input-icon-wrapper password-wrapper">
                  <span className="input-icon" aria-hidden="true">
                    {/* Lock icon */}
              ...
              <div className="auth-switch-text">
                ...
                <span className="auth-switch-link" onClick={() => setIsLogin(true)}>Log In</span>
              </div>
            </>
          )}
        </div>
